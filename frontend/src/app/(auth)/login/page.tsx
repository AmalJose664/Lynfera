...
export default function LoginPage() {
	...
	return (<>
		<div className="relative min-h-screen flex items-center justify-center p-3">
			...
			<div className={cn("w-full p-8 space-y-8 rounded-lg -mt-5", toggleEmail ? "max-w-xl h-[577px]" : "max-w-md h-[526px]", "transition-all")}>
	...
	return (
		<motion.div key={"inputs-component"} animate={{ y: 0 }} exit={{ y: 400 }} initial={{ y: 400 }} transition={{ duration: .7, ease: "backInOut" }}>
			<div className="border rounded-md px-3 py-2 dark:bg-background bg-white">
				{/* <h3 onClick={() => setShowOtpForm(!showOtpForm)}> toggle otp box</h3> */}
				{showOtpForm && (
